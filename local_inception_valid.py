...
from inceptionNet import SimpleNet
...
sys.stdout = Logger('simpleinception.log', sys.stdout)

# model = SimpleNet().cuda()
model = torch.load('60incepmodel.pkl')
...
for epoch in range(num_epochs):
    ...
    if epoch%20 == 0:
        model_checkpoint = str(epoch)+"incepmodel.pkl"
