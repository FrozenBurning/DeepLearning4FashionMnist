...
class ResNet(nn.Module):
    def __init__(self, ResidualBlock, num_classes=10):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(1,1,kernel_size=1,stride=1,padding=2,bias=False),
        ...
        self.dense1_bn = nn.BatchNorm1d(4096)
        self.dense1_dropout = nn.Dropout()
        self.dense2 = nn.Linear(4096,256)
